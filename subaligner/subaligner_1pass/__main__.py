...
optional arguments:
  ...
  -a AUDIO_PATH [AUDIO_PATH ...], --subtitle_path AUDIO_PATH [AUDIO_PATH ...]
                        File path or URL to the audio file (Extensions of supported audio: .wav)
            ...
            try:
                ...
                if FLAGS.mode == "single":
                    aligned_subs, audio_file_path, voice_probabilities, frame_rate = predictor.predict_single_pass(
                        ...
                        audio_file_path=FLAGS.audio_file_path,
